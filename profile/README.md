...
| **[MankeDoMath](https://github.com/CodeW4VE/MankeDoMath)** | A calculator that **knows what a shulker box is**. Farm rates, item counts and timings without leaving the game, with stacks, shulker boxes, ticks and chunks as real units: `5sb / 2h` works out to items per hour on its own. | `1.0.1` |
